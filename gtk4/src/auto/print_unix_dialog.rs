...
pub struct PrintUnixDialogBuilder {
    ...
    manual_capabilities: Option<PrintCapabilities>,
...
impl PrintUnixDialogBuilder {
    ...
    pub fn build(self) -> PrintUnixDialog {
        ...
        if let Some(ref manual_capabilities) = self.manual_capabilities {
            properties.push(("manual-capabilities", manual_capabilities));
        }
    ...
    pub fn manual_capabilities(mut self, manual_capabilities: PrintCapabilities) -> Self {
        self.manual_capabilities = Some(manual_capabilities);
        self
    }
